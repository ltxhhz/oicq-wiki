...
**返回值**
`Promise`&lt;[Ret](#ret-object)&lt;PrivateMessageEventData | GroupMessageEventData&gt;&gt;
...
### Client.em(name: string, data?: object)
...
self_id|number||√|qq
time|number||√|10位时间戳
post_type|string|"system" \| "request" \| "message" \| "notice" \| "sync"|√|事件类型
system_type|string|"login" \| "online" \| "offline"||实例状态
request_type|string|"friend" \| "group"||请求类型
message_type|string|"private" \| "group" \| "discuss"||消息类型
notice_type|string|"friend" \| "group"||
sync_type|string|"message" \| "profile" \| "status" \| "readed" \| "black"||
sub_type|string|||
